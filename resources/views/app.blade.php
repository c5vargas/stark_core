...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
      ...
      <link rel="icon" type="image/x-icon" href="{{ $settings->app_favicon }}">
  ...
  <body class="m-0 font-sans antialiased font-normal text-left leading-default text-base bg-gray-50 text-slate-500">
    <noscript>
