  ...
  return (
    <div className="space-y-4">
      <div className="bg-white shadow rounded p-4">
        <h6 className="text-lg font-semibold mb-0">{t("dashboard.settings.general")}</h6>
        <p className="text-gray-500 mb-3">{t("dashboard.settings.general_desc")}</p>
      ...
      <div className="bg-white shadow rounded p-4">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <BaseButton title={t("dashboard.settings.update")} variant="primary" loading={updating} type="submit" /> 
        </form>
      </div>
    </div>
  );
