    ...
    <DashboardLayout>
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ $t('dashboard.settings.mail') }}</li>
            </ol>
        </nav>
...
import FormComponent from "@/js/contexts/admin/settings/mail/components/FormComponent.vue";
import SendTestComponent from "@/js/contexts/admin/settings/mail/components/SendTestComponent.vue";
