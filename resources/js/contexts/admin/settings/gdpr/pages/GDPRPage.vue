    ...
    <DashboardLayout>
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ $t('dashboard.settings.gdpr') }}</li>
            </ol>
        </nav>
...
import FormComponent from "@/js/contexts/admin/settings/gdpr/components/FormComponent.vue";;
