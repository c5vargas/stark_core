    ...
    <DashboardLayout>
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ $t('dashboard.settings.one_signal') }}</li>
            </ol>
        </nav>
...
import FormComponent from "@/js/contexts/admin/settings/notifications/components/FormComponent.vue";
