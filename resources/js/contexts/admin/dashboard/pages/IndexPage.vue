            ...
            <div class="d-flex align-items-center flex-wrap text-nowrap">
                <div class="input-group flatpickr wd-200 me-2 mb-2 mb-md-0" id="dashboardDate">
                    <span class="input-group-text input-group-addon bg-transparent border-primary" data-toggle><i
                            class="text-primary bi bi-calendar-event"></i></span>
                    <input type="text" class="form-control bg-transparent border-primary" placeholder="Select date"
                        data-input>
                </div>
                <button type="button" class="btn btn-outline-primary btn-icon-text me-2 mb-2 mb-md-0">
                    <i class="btn-icon-prepend bi bi-printer"></i>
                    Print
                </button>
                <button type="button" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
                    <i class="btn-icon-prepend bi bi-cloud-download"></i>
                    Download Report
                </button>
            </div>
        </div>
                                ...
                                <div class="d-flex justify-content-between align-items-baseline">
                                    ...
                                    <div class="dropdown mb-2">
                                        <a type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"
                                            ...
                                            <i class="text-muted pb-3px bi bi-three-dots"></i>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item d-flex align-items-center" href="javascript:;">
                                                <i class="icon-sm me-2 bi bi-eye"></i>
                                                <span class="">View</span></a>
                                            <a class="dropdown-item d-flex align-items-center" href="javascript:;">
                                                <i class="icon-sm me-2 bi bi-pencil"></i>
                                                <span class="">Edit</span></a>
                                            <a class="dropdown-item d-flex align-items-center" href="javascript:;">
                                                <i class="icon-sm me-2 bi bi-download"></i>
                                    ...
                                    <div class="col-6 col-md-12 col-xl-5">
                                        ...
                                        <div class="d-flex align-items-baseline">
                                            <p class="text-success">
                                                <span>+3.3%</span>
                                                <i class="icon-sm mb-1 bi bi-arrow-up-short"></i>
                                            </p>
                                        </div>
                                    </div>
