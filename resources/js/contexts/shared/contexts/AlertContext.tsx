...
export const AlertProvider = ({ children }: { children: ReactNode }) => {
  ...
  const AlertComponent = () => {
    ...
    const positionClass =
      type === 'warning' ? 'inset-0 flex flex-col items-center justify-center' : 'top-2 right-2'

    return (
      <div
        className={`fixed mb-4 rounded-lg border p-4 shadow ${alertColors[type]} ${positionClass} z-[1000] max-w-full`}
        role="alert"
      >
